# NAME : GHSOT
# FB GROUP : GHSOT KING-COMMAND WORLD 2026
# FB ID : GHOST
...
for ua in range(5000):
	...
	ugen.append(alhaj)
os.system("xdg-open https://www.facebook.com/jihadhasan1002")
# LOGO
logo = ("""
\033[1;31m $$$$$$\  $$\   $$\  $$$$$$\   $$$$$$\ $$$$$$$$\ 
...
\033[1;33m   [+]        ON GITHUB    :  JIHAD BRO              \033[1;94m
...
def Main():
        ...
        if Ghost in ["1","01"]:
            sexy()
        if Ghost in ["2","02"]:
        	os.system('xdg-openhttps://www.facebook.com/jihadhasan1002')
        if Ghost in [" 0", "00"]:
            exit()
        else:
            exit()     
